...
class VehicleData:
    ...
    def get_vehicle_input_data_frame(self) -> DataFrame:
        """
        This function returns a DataFrame from Vehicle InsuranceData Class Input
        """
        try:
    ...
    def get_vehicle_data_as_dict(self):
        ...
        """
        logging.info("Entered get_vehicle_insurance_data_as_dict method of VehicleData Class")
        try:
            input_data = {
                "Gender": [self.Gender],
                "Age": [self.Age],
