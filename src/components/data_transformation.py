...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            logging.exception("Exception occurred in get_data_transformer_object method of DataTransformaion Class")
    ...
    def _map_gender_column(self, df):
        ...
        """
        logging.info("Mappiing 'Gender' column to binary values")
    ...
    def _rename_columns(self, df):
        ...
        """
        logging.info("Renaming specific columns and casting int")
