...
class ModelEvaluation:
    ...
    def get_best_model(self) -> Optional[Proj1Estimator]:
        ...
        Description : This function is used to get the model from production stage.
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        ...
        try:
            print("-----------------------------------------------------------------------------------------")
            logging.info("Initialize Model Evaluation Component.")
            self.evaluate_model_response = self.evaluate_model()
            s3_model_path = self.model_eval_config.s3_model_key_path

            model_evaluation_artifact = ModelEvaluationArtifact(
                is_model_accepted=self.evaluate_model_response.is_model_accepted,
                s3_model_path=s3_model_path,
                trained_model_path=self.model_trainer_artifact.trained_model_file_path,
                changed_accuracy=self.evaluate_model_response.difference
            )
